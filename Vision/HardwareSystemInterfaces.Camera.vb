...
Namespace HardwareSystemInterfaces
    ...
    Namespace Camera
        ...
        Public Class DSCamCapture
            ...
            Private ImgFormat As Drawing.Imaging.ImageFormat = Nothing
...
#End If
            ...
            Public Sub SaveCurrentFrame(ByVal strFileName As String, ByVal iFormat As Drawing.Imaging.ImageFormat)
            ...
            Private Function SampleCB(ByVal SampleTime As Double, ByVal pSample As IMediaSample) As Integer Implements ISampleGrabberCB.SampleCB
                ...
                If pSample.GetPointer(buffPtr) = 0 And dataLen > 0 Then
                    ...
                    If saveImage Or getImage Then
                        Dim bmp As New Bitmap(m_videoWidth, m_videoHeight, Drawing.Imaging.PixelFormat.Format24bppRgb)
                        Dim bounds As Rectangle = New Rectangle(0, 0, m_videoWidth, m_videoHeight)

                        Dim bmpData As BitmapData = bmp.LockBits(bounds, Drawing.Imaging.ImageLockMode.ReadWrite, Drawing.Imaging.PixelFormat.Format24bppRgb)
